...
#client source files
CLIENT_SOURCES=App/app.c client.c client_packet.c collision.c component.c draw.c entity.c guilayout.c input.c matrix.c modelgen.c scene.c timer.c util.c cJSON.c 
